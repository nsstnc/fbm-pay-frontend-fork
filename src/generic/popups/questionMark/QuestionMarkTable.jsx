...
const QuestionMarkTable = ({text = '', position = ''}) => {
  return (
    <div className={style.question} >
      ...
      <div className={style.hint} style={{width: '18vw'}}>
...
<h3 style={{marginBottom: '.5rem'}}>Card Prices </h3>
                             <div className={style.cardContent}>
                               <div className={`flex`} style={{gap: '0 20%'}}><p>4.5€</p>
                               <p className={appStyle.mainText}>from 1 to 5 cards</p> </div>
                             </div>
   
                             <div className={style.cardContent}>
                              <div className={`flex`} style={{gap: '0 20%'}}> <p>3.5€</p>
                               <p className={appStyle.mainText}>from 6 to 9 cards</p> </div>
                             </div>
   
                             <div className={style.cardContent}>
                               <div className={`flex`} style={{gap: '0 20%'}}><p>2.5€</p>
                               <p className={appStyle.mainText}>from 10 cards</p> </div>
                             </div>
                           </div>
        </div>
