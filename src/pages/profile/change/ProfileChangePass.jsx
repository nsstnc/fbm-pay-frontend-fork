...
import {PROFILE_CHANGE_PROFILE_ROUTE, PROFILE_CHANGE_PASSWORD_ROUTE} from "../../../routing/consts.js";
    ...
    <div className={appStyle.page}>
      ...
      <div className={appStyle.main}>
        ...
        <HeaderItems
          ...
          links={
            [PROFILE_CHANGE_PROFILE_ROUTE, PROFILE_CHANGE_PASSWORD_ROUTE,]
          }
        />
        ...
        <div className={style.pageContent}>
          ...
          <div>
            <div>
              ...
              <p className={appStyle.mainText}>We do not allow you to turn it off for security reasons.</p>
            </div>
            <div>
              <input type="checkbox"/>
            </div>
