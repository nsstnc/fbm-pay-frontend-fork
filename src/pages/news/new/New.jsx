      ...
      <div className={appStyle.main}>
        ...
        <div>
          ...
          <div className={style.text}>
            <p className={appStyle.mainText} style={{ paddingTop: "1rem" }}>
              BIN 436797 is undergoing technical maintenance on the bank
              partner's side, expected to be completed by 13.05.2024. Card
              issuance, payment processing, and balance updates may experience
              disruptions. Any fees charged by the bank for declined
