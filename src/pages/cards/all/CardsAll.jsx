    ...
    const fetchCardDetails = async (cardId) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error("Ошибка при получении данных карты:", response.status, response.statusText, errorText);
                return null;
            }
        } catch (error) {
    ...
    const fetchCards = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorText = await response.text();
                console.error("Ошибка при получении данных карт:", response.status, response.statusText, errorText);
            }
        } catch (error) {
                                ...
                                <Result
                                    ...
                                    content={[
                                        ...
                                        <div className={style.flex}>
                                            <Card card={<img alt="Mastercard" src={mastercard}/>} number={card.number} cardData={card}/>
                                        </div>,
                                        <div className={style.flex} style={{width: "8rem"}}>
                                        ...
                                        <div style={{width: "8rem"}}>
                                            <Status className={statusStyle.Active} text={card.status_name}/>
                                        </div>,
                                        <div style={{width: "8rem"}}>
