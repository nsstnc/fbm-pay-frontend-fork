...
import {PAYMENTS_ACCOUNTS_ROUTE, PAYMENTS_CARDS_ROUTE} from "../../../routing/consts.js";
    ...
    <div className={appStyle.page}>
      ...
      <div className={appStyle.main}>
        ...
        <HeaderItems
          ...
          links={
            [PAYMENTS_CARDS_ROUTE, PAYMENTS_ACCOUNTS_ROUTE]
          }
        />

        <div className={style.pageContent}>
          <Filter title="ACCOUNT’S PAYMENTS"
                  inputs={[
                    [
                      <Input
                   ...
                   results={[
                    <Result content={[
                      ...
                      <p className={appStyle.hint} style={{width: '8rem'}}>DOCUMENT</p>,
                      <p className={appStyle.hint} style={{width: '8rem'}}>DATE</p>,
                      <p className={appStyle.hint} style={{width: '8rem'}}>TIME</p>,
                      <p className={appStyle.hint} style={{width: '8rem'}}>STATUS</p>,
                      <p className={appStyle.hint} style={{width: '10rem'}}>STATUS CHANGE DATE</p>,
                      <p className={appStyle.hint} style={{width: '10rem'}}>TRANSACTION AMOUNT</p>,
                      <p className={appStyle.hint} style={{width: '10rem'}}>ACCOUNT AMOUNT</p>,
                      <p className={appStyle.hint} >PAYMENT DETAILS</p>,
                      <p className={appStyle.hint}>CARD NUMBER</p>,
                      <p className={appStyle.hint} style={{paddingLeft: '50px'}}>CARD NAME</p>,
                    ]}/>,
                    <Result content={[
                      // eslint-disable-next-line react/jsx-key
                      <p className={appStyle.mainText} style={{width: '8rem'}}>69892977</p>,
                      <p className={appStyle.mainText} style={{width: '8rem'}}>10.04.2024</p>,
                      <p className={appStyle.mainText} style={{width: '8rem'}}>11:59</p>,
                      <div style={{width: '8rem'}}>
                        <Status className={statusStyle.Pending} text="Pending"/>
                      </div>,
                      <p className={appStyle.mainText} style={{width: '10rem'}}>10.04.2024</p>,
                      <p className={appStyle.mainText} style={{width: '10rem'}}>-€25.00</p>,
                      <p className={appStyle.mainText} style={{width: '10rem'}}>-€22.00</p>,
                      ...
                      <div className={style.flex} style={{paddingLeft: '50px'}}>
                        <div className={style.accountId}>
                          <p className={`${appStyle.green} ${appStyle.mainText}`}>Card 1</p>
                        </div>
                      </div>,
                    ]}/>,
                    <Result content={[
